...
export const initialValueForcedLayout: any = (
  <fragment>
    ...
    <hp>
      An editor can edit complex, nested data structures. And for the most
...
export const initialValuePreview: any = (
  <fragment>
    ...
    <hp>
      The editor is flexible enough to add **decorations** that can format text based
...
export const initialValuePasteHtml: any = [
  ...
  },
  {
    ...
    children: [
      {
        text:
          "By default, pasting content into the editor will use the clipboard's ",
      },
...
export const initialValueList: any = [
  ...
  },
  {
    ...
    children: [
      {
        text:
          'With the editor you can build complex block types that have their own embedded content and behaviors, like rendering checkboxes inside check list items!',
      },
    ],
  },
  {
